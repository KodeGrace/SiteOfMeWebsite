    ...
    <body>
        <div class="container">
            ...
            if (isset($_GET['id'])) {
                ...
                $sql = "SELECT * FROM tb_tulisan WHERE id = $id";
            ...
            if ($_SERVER["REQUEST_METHOD"] == "POST") {
                ...
                //Query update data pada tabel tulisan
                $sql = "UPDATE tb_tulisan SET username='$username', email='$email', kategori='$kategori', tulisan='$tulisan' WHERE id = $id";
            ...
            <h2> <center> Update Data Tulisan </center> </h2>
