...
<html lang="en">
  ...
  <body>
    ...
    <div class="jumbotron">
        ...
        <p class="lead">Bagi kalian yang ingin karya tulisannya di posting dalam website kami silahkan bergabung dengan kami yaa</p>
        <hr class="my-4">
        <p>Ingin Menyumbangkan Tulisanmu?</p>
        
        <a class="btn btn-outline-info btn-lg" href="login.php" role="button">Silahkan Gabung Di Sini</a>
    </div>
